...
#include "NamdTypes.h" // CudaAtom, DpcppAtom
#include "Lattice.h"
#ifdef NAMD_DPCPP
#include <CL/sycl.hpp>
...
#endif
#ifdef NAMD_DPCPP
  virtual void copyAtoms(const int numAtoms, const DpcppAtom* atoms)=0;
#endif
...
#endif
#ifdef NAMD_DPCPP
  virtual void gatherForce(Lattice &lattice, DpcppForce* force)=0;
#endif
...
#endif
#ifdef NAMD_DPCPP
  virtual void transposeXYZtoYZX(const sycl::float2 *data) = 0;
  virtual void transposeXYZtoZXY(const sycl::float2 *data) = 0;
#endif
};
