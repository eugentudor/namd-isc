...
#ifdef NAMD_DPCPP
class DpcppComputeNonbonded;
class DpcppComputeBonded;
#endif
...
#ifdef NAMD_DPCPP
  void sendAssignPatchesOnPe(std::vector<int>& pes, DpcppComputeNonbonded* c);
  void recvAssignPatchesOnPe(DpcppComputeNonbondedMsg *msg);
  void sendSkipPatchesOnPe(std::vector<int>& pes, DpcppComputeNonbonded* c);
  void recvSkipPatchesOnPe(DpcppComputeNonbondedMsg *msg);
  void sendFinishPatchesOnPe(std::vector<int>& pes, DpcppComputeNonbonded* c);
  void recvFinishPatchesOnPe(DpcppComputeNonbondedMsg *msg);
  void sendFinishPatchOnPe(int pe, DpcppComputeNonbonded* c, int i, PatchID patchID);
  void recvFinishPatchOnPe(DpcppComputeNonbondedMsg *msg);
  void sendOpenBoxesOnPe(std::vector<int>& pes, DpcppComputeNonbonded* c);
  void recvOpenBoxesOnPe(DpcppComputeNonbondedMsg *msg);
  void sendFinishReductions(int pe, DpcppComputeNonbonded* c);
  void recvFinishReductions(DpcppComputeNonbondedMsg *msg);
  void sendMessageEnqueueWork(int pe, DpcppComputeNonbonded* c);
  void recvMessageEnqueueWork(DpcppComputeNonbondedMsg *msg);
  void sendLaunchWork(int pe, DpcppComputeNonbonded* c);
  void recvLaunchWork(DpcppComputeNonbondedMsg *msg);
  void sendUnregisterBoxesOnPe(std::vector<int>& pes, DpcppComputeNonbonded* c);
  void recvUnregisterBoxesOnPe(DpcppComputeNonbondedMsg *msg);
  // Bonded Offload
  void sendAssignPatchesOnPe(std::vector<int>& pes, DpcppComputeBonded* c);
  void recvAssignPatchesOnPe(DpcppComputeBondedMsg *msg);
  void sendMessageEnqueueWork(int pe, DpcppComputeBonded* c);
  void recvMessageEnqueueWork(DpcppComputeBondedMsg *msg);
  void sendOpenBoxesOnPe(std::vector<int>& pes, DpcppComputeBonded* c);
  void recvOpenBoxesOnPe(DpcppComputeBondedMsg *msg);
  void sendLoadTuplesOnPe(std::vector<int>& pes, DpcppComputeBonded* c);
  void recvLoadTuplesOnPe(DpcppComputeBondedMsg *msg);
  void sendLaunchWork(int pe, DpcppComputeBonded* c);
  void recvLaunchWork(DpcppComputeBondedMsg *msg);
  void sendFinishPatchesOnPe(std::vector<int>& pes, DpcppComputeBonded* c);
  void recvFinishPatchesOnPe(DpcppComputeBondedMsg *msg);
  void sendFinishReductions(int pe, DpcppComputeBonded* c);
  void recvFinishReductions(DpcppComputeBondedMsg *msg);
  void sendUnregisterBoxesOnPe(std::vector<int>& pes, DpcppComputeBonded* c);
  void recvUnregisterBoxesOnPe(DpcppComputeBondedMsg *msg);
#endif
