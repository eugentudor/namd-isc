#ifndef DPCPPCOMPUTEBONDED_H
#define DPCPPCOMPUTEBONDED_H
#include "Compute.h"
...
class DpcppComputeBonded : public Compute {

public:

  static const int DpcppTupleTypeSize[Tuples::NUM_TUPLE_TYPES];
...
private:
  ...
  // Dpcpp Bonded kernel
  DpcppComputeBondedKernel bondedKernel;
...
public:
  ...
  DpcppComputeBonded(ComputeID c, ComputeMgr* computeMgr, int deviceID, DpcppNonbondedTables& dpcppNonbondedTables);
  ~DpcppComputeBonded();
