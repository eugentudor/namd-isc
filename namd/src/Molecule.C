  ...
  
{
  ...
  char mainfilename[NAMD_FILENAME_BUFFER_SIZE];  //  main moving drag PDB filename
  char velfilename[NAMD_FILENAME_BUFFER_SIZE];   //  moving drag velocity PDB filename
  ...
  
{
  ...
  char mainfilename[NAMD_FILENAME_BUFFER_SIZE];  //  main rotating drag PDB filename
  char axisfilename[NAMD_FILENAME_BUFFER_SIZE];  //  rotating drag axis PDB filename
  char pivotfilename[NAMD_FILENAME_BUFFER_SIZE]; //  rotating drag pivot point PDB filename
  char velfilename[NAMD_FILENAME_BUFFER_SIZE];   //  rotating drag angular velocity PDB filename
  ...
  
{
  ...
  int dvcol = 4;           //  Column to look for angular velocity in
  Real dvval = 0;          //  Angular velocity value retreived
  char mainfilename[NAMD_FILENAME_BUFFER_SIZE];  //  main "constant" torque PDB filename
  char axisfilename[NAMD_FILENAME_BUFFER_SIZE];  //  "constant" torque axis PDB filename
  char pivotfilename[NAMD_FILENAME_BUFFER_SIZE]; //  "constant" torque pivot point PDB filename
  char velfilename[NAMD_FILENAME_BUFFER_SIZE];   //  "constant" torque angular velocity PDB filename
